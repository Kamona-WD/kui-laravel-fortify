            ...
            <div class="grid gap-6">
                <div class="space-y-2">
                    ...
                    <InputIconWrapper>
                        ...
                        <Input withIcon id="email" type="email" class="block w-full" :placeholder="$t(`Email`)" v-model="form.email" required autofocus autocomplete="username" />
                    </InputIconWrapper>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <InputIconWrapper>
                        ...
                        <Input withIcon id="password" type="password" class="block w-full" :placeholder="$t(`Password`)" v-model="form.password" required autocomplete="current-password" />
                    </InputIconWrapper>
                </div>
